...
p.BaseErr <- grid.arrange(H100.errPlot, H0.errPlot, nrow = 1)
p.BaseErr <- annotate_figure(p.BaseErr, fig.lab = "A", fig.lab.size = 14, fig.lab.face = "bold")

p.BaseExpr <- grid.arrange(H100.expPlot, H0.expPlot, H10.expPlot, H85.expPlot, nrow = 2)
p.BaseExpr <- annotate_figure(p.BaseExpr, fig.lab = "B", fig.lab.size = 14, fig.lab.face = "bold")

p.FacsErr <- grid.arrange(p.H, p.M, nrow = 1)
p.FacsErr <- annotate_figure(p.FacsErr, fig.lab = "C", fig.lab.size = 14, fig.lab.face = "bold")

jpeg(filename = "AlignmentQC/qcPlot.jpeg", quality = 0.95, height = 8.5, 
     width = 8, res = 300, units = "in")
grid.arrange(p.BaseErr, p.BaseExpr,
